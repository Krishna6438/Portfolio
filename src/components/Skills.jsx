            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                {skills.map((group, index) => (
                    <div
                        ...
                        onMouseEnter={() => setActiveCard(index)} // Handle hover for PC
                        onMouseLeave={() => setActiveCard(null)} // Reset on hover out
                        style={{
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-sm text-gray-400">Hover or tap to explore skills</p>
                        </div>
